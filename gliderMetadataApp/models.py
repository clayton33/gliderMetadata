...
class Mission(models.Model):
    ...
    mission_batteryMax = models.DecimalField(max_digits=3, decimal_places=1, null=True)
    mission_batteryMin = models.DecimalField(max_digits=3, decimal_places=1, null=True)
    mission_deploymentVessel = models.ForeignKey(Vessel, related_name='deploymentVessel', on_delete=models.SET_NULL, null=True)
    mission_deploymentLongitude = models.DecimalField(max_digits=7, decimal_places=4, null=True)
    mission_deploymentLatitude = models.DecimalField(max_digits=6, decimal_places=4, null=True)
    ...
    mission_waypointsGiven = models.CharField(max_length=100, null=True)
    mission_distanceTravelled = models.DecimalField(max_digits=6, decimal_places=2, null=True)
    mission_numberOfYos = models.IntegerField(null=True)
    mission_numberOfScienceYos = models.CharField(max_length=20, null=True)
    mission_profilingScheme = models.CharField(max_length=20, null=True)
    mission_numberOfAlarms = models.CharField(max_length=5, null=True)
    mission_numberOfAlarmsWithOT = models.IntegerField(null=True)
    mission_hoursOfOT = models.IntegerField(null=True)
    mission_ballastedDensity = models.DecimalField(max_digits=6, decimal_places=2, null=True)
    ...
    mission_location = models.CharField(max_length=300, null=True)
